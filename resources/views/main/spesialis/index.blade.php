    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex align-items-center">
                <div class="mr-auto p-2 f20 f-bold">List Spesialis</div>
                <a href="/admin/spesialis/add" class="btn my-button my-rounded pl-3 pr-3">
                    <i class="fa fa-plus mr-3"></i>New
                </a>
            </div>
            <div class="dropdown-divider mt-4"></div>
            @if(count($spesialis) > 0)
                    ...
                    @foreach($spesialis as $v)
                        <tr>
                            ...
                            <td class="text-center">
                                <a data-id="{{ $v->id }}" href="/admin/spesialis/edit/{{$v->id}}"><i
        ...
        function destroy(id) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    let res = await $.post('/admin/spesialis/destroy/'+id, data);
                    Swal.fire(
                        'Deleted!',
