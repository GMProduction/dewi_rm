...
@section('content-title')
    <div>
        ...
        <div class="my-text-semi-dark f14">Semua Data Rekam Medis Di Rumah Sakit</div>
    </div>
@endsection
@section('breadcrumb')
    <div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex align-items-center">
                <div class="mr-auto p-2 f20 f-bold">List Rekam Medis</div>
                ...
                <table id="my-table" class="table display">
                    ...
                    @foreach($rekams as $rekam)
                        <tr>
                            ...
                            <td>{{ $rekam->resep->dokter->nama }}</td>
                            <td>{{ $rekam->resep->pasien->nama }}</td>
                            <td>{{ $rekam->resep->no_resep }}</td>
                            <td>{{ $rekam->keluhan }}</td>
                            <td class="text-center">
                                <a data-id="{{ $rekam->id }}" href="/admin/resep/edit/{{$rekam->id}}"><i
                                        class="fa fa-edit"></i></a>
                                <a data-id="{{ $rekam->id }}" href="#"><i class="fa fa-trash-o"></i></a>
                                <a data-id="{{ $rekam->id }}" href="/admin/resep/detail/{{ $rekam->id }}"><i class="fa fa-ellipsis-v"></i></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
