...
@section('content-title')
    <div>
        <div class="f20 f-bold" style="letter-spacing: 1px;"><i class="fa fa-cube mr-2"></i>Data Diagnosa
        </div>
        <div class="my-text-semi-dark f14">Data Diagnosa</div>
    </div>
@endsection
@section('breadcrumb')
    <div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex align-items-center">
                <div class="mr-auto p-2 f20 f-bold">Daftar Diagnosa</div>
...
@section('js')
    ...
    <script>
        ...
        function cetak() {
            ...
            let tgl1 = $('#tgl1').val();
            let tgl2 = $('#tgl2').val();
            window.open('/admin/report/diagnosa/print?tgl1=' + tgl1 + '&tgl2=' + tgl2, '_blank');
        }
