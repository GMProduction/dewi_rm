    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex align-items-center">
                <div class="mr-auto p-2 f20 f-bold">List Dokter</div>
                <a href="/admin/dokter/add" class="btn my-button my-rounded pl-3 pr-3">
                    ...
                    @foreach($dokters as $dokter)
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a data-id="{{ $dokter->id }}" href="#" onclick="destroy('{{ $dokter->user->id }}')"><i class="fa fa-trash-o"></i></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
        ...
        function destroy(id) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    let res = await $.post('/admin/dokter/destroy/'+id, data);
                    console.log(res);
                    Swal.fire(
                        'Deleted!',
