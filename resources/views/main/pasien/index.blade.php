    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex align-items-center">
                <div class="mr-auto p-2 f20 f-bold">Daftar Pasien</div>
                <a href="/admin/pasien/add" class="btn my-button my-rounded pl-3 pr-3">
                    ...
                    @foreach($pasiens as $pasien)
                        <tr>
                            ...
                            <td class="text-center">
                                <a data-id="{{ $pasien->id }}" href="/admin/pasien/edit/{{$pasien->id}}"><i
                                        class="fa fa-edit"></i></a>
                                <a data-id="{{ $pasien->id }}" href="#" onclick="destroy('{{ $pasien->user->id }}')"><i class="fa fa-trash-o"></i></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
        ...
        function destroy(id) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    let res = await $.post('/admin/pasien/destroy/'+id, data);
                    console.log(res);
                    Swal.fire(
                        'Deleted!',
