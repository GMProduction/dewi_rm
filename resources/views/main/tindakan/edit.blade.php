...
@section('breadcrumb')
    <div>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="/admin/tindakan">Tindakan</a></li>
        ...
        <div class="col-lg-7 col-sm-12">
            <div class="card card-outline card-primary my-card">
                <div class="card-header">
                    <div class="card-title">Form Tindakan</div>
                </div>
                <div class="card-body">
                    <form method="POST" action="/admin/tindakan/patch">
                        @csrf
                        <input name="id" type="hidden" value="{{ $tindakan->id }}">
                        <x-lazy.input.text id="name" name="name" label="Nama Tindakan" value="{{ $tindakan->name }}"/>
